  ...
  <main class="flex h-full w-full flex-col pr-6">
    ...
    <FadeTransition>
      ...
      >
          ...
          >
            ...
            >
              ...
              <n-dynamic-input
                ...
                :disabled="
                  item.name_type === 'Organizational' || studyStore.currentStudyRole === 'viewer'
                "
        ...
        <h2 class="pb-4">Managing organization</h2>

...
onBeforeMount(async () => {
  const response = await fetch(`${baseURL}/study/${studyId}/dataset/${datasetId}/consent`, {
    method: "GET",
  });
  ...
  <main class="flex h-full w-full flex-col pr-6">
    ...
    >
      ...
      <n-form-item
        ...
        show-require-mark
      >
        <n-switch v-model:value="moduleData.noncommercial" :round="true" class="mx-1" size="large">
      ...
      <n-form-item
        ...
        show-require-mark
      >
        <n-switch v-model:value="moduleData.geog_restrict" :round="true" class="mx-1" size="large">
          <template #checked> Yes </template>
          <template #unchecked> No </template>
        </n-switch>
      </n-form-item>
      ...
      <n-form-item
        ...
        show-require-mark
      >
        <n-switch v-model:value="moduleData.research_type" :round="true" class="mx-1" size="large">
          <template #checked> Yes </template>
          <template #unchecked> No </template>
        </n-switch>
      </n-form-item>
